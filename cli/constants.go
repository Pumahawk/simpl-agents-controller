...
var prEidasKeycloak = PrInfo{2218, "maven", "eidas-keycloak"}
var prEidasNode = PrInfo{1312, "helm", "eidas-node"}
var prFeAuthenticationProvider = PrInfo{2224, "helm", "fe-authentication-provider"}
var prFeIdentityProvider = PrInfo{2120, "helm", "fe-identity-provider"}
var prFeOnboarding = PrInfo{2098, "helm", "fe-onboarding"}
var prFeSecurityAttributeProvider = PrInfo{2226, "helm", "fe-security-attribute-provider"}
